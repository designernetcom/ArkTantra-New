...
if ($first_name === '' || !preg_match("/^[a-zA-Z\s]+$/", $fname)) {
    echo "Enter valid First Name";
    exit;
}

if ($last_name === '' || !preg_match("/^[a-zA-Z\s]+$/", $lname)) {
...
try {
    ...
    $mail->setFrom("sales@arktantra.com", "Website Contact Form");
    $mail->addAddress("sales@arktantra.com");
...
Thank you for contacting <b>ArkTantra Cyber Security Solutions</b>.<br>
We received your enquiry and our team will contact you shortly.<br><br>

Regards,<br>
Team ArkTantra Cyber Security Solutions
";
